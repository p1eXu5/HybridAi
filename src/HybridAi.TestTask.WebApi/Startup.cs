...
namespace HybridAi.TestTask.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext< IpDbContext >( options => {
                options.UseNpgsql( Configuration[ "DataContext:Database:ConnectionString" ] );
            } );
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            var dbContext = serviceScope.ServiceProvider.GetRequiredService< IpDbContext >();
